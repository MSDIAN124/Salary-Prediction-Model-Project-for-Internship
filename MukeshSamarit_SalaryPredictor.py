"""
MukeshSamarit_SalaryPredictor.py  –  DS Jobs Salary Predictor
======================================
...
How to run
----------
From the project root (Cleaned_DS_Jobs.csv must be in the same folder):
    python MukeshSamarit_SalaryPredictor.py

Output
------
    model/pipeline.pkl   – serialised sklearn pipeline
    model/meta.json      – feature lists + eval metrics
"""
...
ROOT       = THIS_FILE.parent.parent          # parent of project root
MODEL_DIR  = THIS_FILE.parent / "model"       # <project root>/model/
